...
import 'package:comida_de_verdade/login_page/login_page_widget.dart';
...
class _MyAppState extends State<MyApp> {
  Locale _locale;
  Stream<ComidaDeVerdadeFirebaseUser> userStream;
  ComidaDeVerdadeFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = comidaDeVerdadeFirebaseUserStream()
